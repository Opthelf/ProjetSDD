all : exo8.o exo7.o exo6.o exo5.o exo4.o exo3.o exo2.o exo1.o main.o myGit.o
	gcc -g exo8.o exo7.o exo6.o exo5.o exo4.o exo3.o exo2.o exo1.o main.o -o main 
	gcc -g exo8.o exo7.o exo6.o exo5.o exo4.o exo3.o exo2.o exo1.o myGit.o -o myGit
